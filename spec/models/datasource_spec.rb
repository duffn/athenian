...
# Unit tests for Athenian::Datasource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Athenian::Datasource do
  let(:instance) { Athenian::Datasource.new }

  describe 'test an instance of Datasource' do
    it 'should create an instance of Datasource' do
      expect(instance).to be_instance_of(Athenian::Datasource)
    end
  end
end
