...
# Unit tests for Athenian::Contributor
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Athenian::Contributor do
  let(:instance) { Athenian::Contributor.new }

  describe 'test an instance of Contributor' do
    it 'should create an instance of Contributor' do
      expect(instance).to be_instance_of(Athenian::Contributor)
    end
  end
