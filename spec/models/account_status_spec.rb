...
# Unit tests for Athenian::AccountStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Athenian::AccountStatus do
  let(:instance) { Athenian::AccountStatus.new }

  describe 'test an instance of AccountStatus' do
    it 'should create an instance of AccountStatus' do
      expect(instance).to be_instance_of(Athenian::AccountStatus)
    end
  end
  ...
  describe 'test attribute "has_jira"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "has_ci"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "has_deployments"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
