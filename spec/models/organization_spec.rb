...
# Unit tests for Athenian::Organization
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Athenian::Organization do
  let(:instance) { Athenian::Organization.new }

  describe 'test an instance of Organization' do
    it 'should create an instance of Organization' do
      expect(instance).to be_instance_of(Athenian::Organization)
    end
  end
