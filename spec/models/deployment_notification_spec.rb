...
# Unit tests for Athenian::DeploymentNotification
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Athenian::DeploymentNotification do
  let(:instance) { Athenian::DeploymentNotification.new }

  describe 'test an instance of DeploymentNotification' do
    it 'should create an instance of DeploymentNotification' do
      expect(instance).to be_instance_of(Athenian::DeploymentNotification)
    end
  end
