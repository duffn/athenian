...
module Athenian
  ...
  class MappedJIRAIdentity
    ...
    def self.openapi_types
      {
        :'developer_id' => :'ReleasedPullRequestAuthor',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, 'The input argument (attributes) must be a hash in `Athenian::MappedJIRAIdentity` initialize method'
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Athenian::MappedJIRAIdentity`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'developer_id')
        self.developer_id = attributes[:'developer_id']
      end

      if attributes.key?(:'developer_name')
        self.developer_name = attributes[:'developer_name']
      end

      if attributes.key?(:'jira_name')
        self.jira_name = attributes[:'jira_name']
      end
    ...
    def list_invalid_properties
      ...
      if @developer_id.nil?
        invalid_properties.push('invalid value for "developer_id", developer_id cannot be nil.')
      end

      if @jira_name.nil?
        invalid_properties.push('invalid value for "jira_name", jira_name cannot be nil.')
      end
    ...
    def valid?
      return false if @developer_id.nil?
      return false if @jira_name.nil?
      return false if @confidence.nil?
      return false if @confidence > 1
      return false if @confidence < 0
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          developer_name == o.developer_name &&
          jira_name == o.jira_name &&
