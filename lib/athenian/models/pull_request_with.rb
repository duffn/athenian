  ...
  class PullRequestWith
    ...
    def self.openapi_types
      {
        ...
        :'commit_author' => :'Array<String>',
        :'commit_committer' => :'Array<String>',
        :'commenter' => :'Array<String>',
        :'merger' => :'Array<String>',
        :'releaser' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, 'The input argument (attributes) must be a hash in `Athenian::PullRequestWith` initialize method'
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Athenian::PullRequestWith`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'reviewer')
        if (value = attributes[:'reviewer']).is_a?(Array)
          self.reviewer = value
        end
      end

      if attributes.key?(:'commit_author')
        if (value = attributes[:'commit_author']).is_a?(Array)
          self.commit_author = value
        end
      end

      if attributes.key?(:'commit_committer')
        if (value = attributes[:'commit_committer']).is_a?(Array)
          self.commit_committer = value
        end
      end

      if attributes.key?(:'commenter')
        if (value = attributes[:'commenter']).is_a?(Array)
          self.commenter = value
        end
      end

      if attributes.key?(:'merger')
        if (value = attributes[:'merger']).is_a?(Array)
          self.merger = value
        end
      end

      if attributes.key?(:'releaser')
        if (value = attributes[:'releaser']).is_a?(Array)
          self.releaser = value
        end
      end
    end
    ...
    def hash
      [author, reviewer, commit_author, commit_committer, commenter, merger, releaser].hash
    end
