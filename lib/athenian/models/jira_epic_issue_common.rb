...
module Athenian
  ...
  class JIRAEpicIssueCommon
    ...
    def hash
      [id, title, created, updated, work_began, resolved, lead_time, life_time, reporter, assignee, comments, comment_list, priority, rendered_description, status, story_points, type, url].hash
    end
